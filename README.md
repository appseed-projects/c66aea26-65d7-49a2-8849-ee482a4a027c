...
- Timestamp: `2022-06-09 06:59`
- Build ID: `c66aea26-65d7-49a2-8849-ee482a4a027c`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c66aea26-65d7-49a2-8849-ee482a4a027c.git
$ cd c66aea26-65d7-49a2-8849-ee482a4a027c
```
